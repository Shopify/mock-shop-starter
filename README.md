...
- Carts work, so you can build the full shopping flow, but checkout isn't available.
- The Customer Account API isn't available, so the `/account` routes need a real store.
