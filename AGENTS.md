...
- Carts work. Checkout is mocked (no payment, no real order). The Customer Account API isn't available, so `/account` routes error. Products, prices, and inventory are fictional.
